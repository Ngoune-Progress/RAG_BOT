...
def handle_query_sop():
    ...
    try:
        ...
        logging.error(f"Error processing the SOP query: {str(e)}")
...
def initialize_rag_chain_and_vector_store(document_directory):
    ...
    return rag_chain, conversational_rag_chain

@app.before_first_request
def setup():
    global rag_chain_sop, conversational_rag_chain_sop, rag_chain_faq, conversational_rag_chain_faq
    
    document_directory_sop = "./documents_sop"
    rag_chain_sop, conversational_rag_chain_sop = initialize_rag_chain_and_vector_store(document_directory_sop)
    
    document_directory_faq = "./documents_faq"
    rag_chain_faq, conversational_rag_chain_faq = initialize_rag_chain_and_vector_store(document_directory_faq)
